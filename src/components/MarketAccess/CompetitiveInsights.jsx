...
const CompetitiveInsights = () => {
    ...
    const competitiveInsights = [
        { description: "ANTHEM BLUE CROSS (CA) updates access criteria approximately every 90 days, requiring regular monitoring and strategy adjustment.",
  ...
  return (
    <div className="w-full  border border-gray-300 rounded-xl bg-gray-700 flex flex-col p-2">
      ...
      <div className='flex p-1 gap-2 items-center'>
        ...
        <h2 className="text-[14px] font-semibold text-white">Competitive Insights</h2>
